...
public class SolutionController {
    ...
    public Mono<BodyResponse<Object>> addAlimento(@RequestBody Solution solution,
    ...
    @GetMapping
    public Flux<Solution> getAlimentos() {
        return solutionImputPort.findAll();
    }
    ...
    @PutMapping("/update")
    public Mono<BodyResponse<Object>> updateAlimento(@RequestBody Solution solution,
                                                     @RequestHeader("idtransacion") String idtransacion) {
    ...
    public Flux<SolutionCun>  getAlimentoByName(@PathVariable String name,
                                                @RequestHeader("idtransacion") String idtransacion) {
